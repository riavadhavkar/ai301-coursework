...
I'm a full-stack platform engineer, so I'm comfortable on both ends: Java/Spring
Boot, AWS microservices, Docker, Jenkins, and OpenTelemetry are what I use daily
at work, and while Angular/React/TypeScript aren't part of my day job, I've used
them in personal projects and am comfortable picking up frontend/UI work too.
Where I'm weaker is deep system-level work and system design — I'd like this
course to be a place I build that up rather than avoid it, so issues that touch
lower-level internals or design tradeoffs are ones I actively want, not ones to
filter out. If an issue's context or thread explicitly encourages AI-assisted
approaches to solving it, that's a strong plus for me — I'd rank those higher.
